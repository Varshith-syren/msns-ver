...
function createBookCardPendingIssue(id,username) {
    fetch('https://msns-soi.vercel.app/getbook/'+id).then((res)=>{return res.json()}).then((bookData)=>{
        ...
        cancelButtonElement.addEventListener('click',async ()=>{
            await fetch('https://msns-soi.vercel.app/issue/delete/'+username,{body:JSON.stringify({id:id}),method:"POST",headers: { 'Content-Type': 'application/json' }})
            bookCard.remove();
        });
...
function fetchPendingIssue(){
    fetch('https://msns-soi.vercel.app/issue/'+`${usernamecontainer.textContent}`).then((res)=>{return res.json()}).then(async (userissues)=>{
...
function createBookCardBorrowed(book,username) {
    fetch('https://msns-soi.vercel.app/getbook/'+book.bookid).then((res)=>{return res.json()}).then((bookData)=>{
        const bookCard = document.createElement('div');
        ...
        returnButton.addEventListener('click',async ()=>{
                await fetch('https://msns-soi.vercel.app/return/'+username,{body:JSON.stringify({books:[{borrowed:{bookid:book.bookid,duedate:book.duedate}}]}),method:"POST",headers: { 'Content-Type': 'application/json' }});
                await fetch('https://msns-soi.vercel.app/borrow/delete/'+username,{body:JSON.stringify({id:book.bookid}),method:"POST",headers: { 'Content-Type': 'application/json' }});
...
function fetchPendingBorrow(){
    fetch('https://msns-soi.vercel.app/borrow/'+`${usernamecontainer.textContent}`).then((res)=>{return res.json()}).then(async (userborrow)=>{
...
function fetchPendingReturn(){
    ...
    fetch('https://msns-soi.vercel.app/return/'+`${usernamecontainer.textContent}`).then((res)=>{return res.json()}).then(async (userReturn)=>{
